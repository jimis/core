...
static const ConstraintSyntax file_select_constraints[] =
{
    ...
    ConstraintSyntaxNewIntRange("search_size", CF_VALRANGE, "Integer range of file sizes", SYNTAX_STATUS_NORMAL),
...
static const ConstraintSyntax copy_from_constraints[] =
{
    ...
    ConstraintSyntaxNewIntRange("copy_size", CF_VALRANGE, "Integer range of file sizes that may be copied", SYNTAX_STATUS_NORMAL),
